...
| [flujo-funcional.md](flujo-funcional.md) | Flujos principales paso a paso: login, recuperación de contraseña, navegación protegida, gestión de canjes, auth/autorización, permisos en tabla, **MDM CRUD (datos maestros)**. | Entender qué ocurre en cada flujo de usuario o de sistema. |
